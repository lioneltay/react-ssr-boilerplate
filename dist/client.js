...
/******/ 	var hotCurrentHash = "909782d1acffb19f4a4e"; // eslint-disable-line no-unused-vars
...
/******/ 		return __webpack_require__.p + "" + ({"1":"SecondComponent"}[chunkId]||chunkId) + ".chunk.js"
/******/ 	}
/******/
...
/******/ 	__webpack_require__.p = "/Volumes/Dev/projects/hot-server-demo/dist";
/******/
...
/* harmony import */ var _pages_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34);
/* harmony import */ var lib_async_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46);




Object(lib_async_component__WEBPACK_IMPORTED_MODULE_3__["preloadAll"])().then(() => {
  console.log(Object(lib_async_component__WEBPACK_IMPORTED_MODULE_3__["extractChunks"])());
  Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["hydrate"])(react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_pages_index__WEBPACK_IMPORTED_MODULE_2__["default"]), document.getElementById("app"));
});
...
if (true) {
  (function () {
    ...
    var checkPropTypes = __webpack_require__(20); // TODO: this is special because it gets imported during build.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(true){(function(){'use strict';var invariant=__webpack_require__(16);var React=__webpack_require__(13);var warning=__webpack_require__(18);var ExecutionEnvironment=__webpack_require__(24);var _assign=__webpack_require__(15);var emptyFunction=__webpack_require__(19);var checkPropTypes=__webpack_require__(20);var getActiveElement=__webpack_require__(25);var shallowEqual=__webpack_require__(26);var containsNode=__webpack_require__(27);var emptyObject=__webpack_require__(17);var hyphenateStyleName=__webpack_require__(30);var camelizeStyleName=__webpack_require__(32);// Relying on the `invariant()` implementation lets us
// have preserve the format and params in the www builds.
...
var hasNativePerformanceNow=typeof performance==='object'&&typeof performance.now==='function';var now$1=void 0;if(hasNativePerformanceNow){now$1=function(){return performance.now();};}else{now$1=function(){return Date.now();};}// TODO: There's no way to cancel, because Fiber doesn't atm.
...
var timeoutIds={};scheduleWork=function(callback,options){var callbackId=callbackIdCounter++;var timeoutId=setTimeout(function(){callback({timeRemaining:function(){return Infinity;},didTimeout:false});});timeoutIds[callbackId]=timeoutId;return callbackId;};cancelScheduledWork=function(callbackId){var timeoutId=timeoutIds[callbackId];delete timeoutIds[callbackId];clearTimeout(timeoutId);};}else{// We keep callbacks in a queue.
...
var pendingCallbacks=[];var _callbackIdCounter=0;var getCallbackId=function(){_callbackIdCounter++;return _callbackIdCounter;};// When a callback is scheduled, we register it by adding it's id to this
// object.
...
// frames.
var previousFrameTime=33;var activeFrameTime=33;var frameDeadlineObject={didTimeout:false,timeRemaining:function(){var remaining=frameDeadline-now$1();return remaining>0?remaining:0;}};var safelyCallScheduledCallback=function(callback,callbackId){if(!registeredCallbackIds[callbackId]){// ignore cancelled callbacks
...
delete registeredCallbackIds[callbackId];}};/**
   ...
   */var callTimedOutCallbacks=function(){if(pendingCallbacks.length===0){return;}var currentTime=now$1();// TODO: this would be more efficient if deferred callbacks are stored in
// min heap.
...
var messageKey='__reactIdleCallback$'+Math.random().toString(36).slice(2);var idleTick=function(event){if(event.source!==window||event.data!==messageKey){return;}isIdleScheduled=false;if(pendingCallbacks.length===0){return;}// First call anything which has timed out, until we have caught up.
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36);
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_hot_loader__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lib_async_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46);
/* harmony import */ var components_StaticComponent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(47);
(function () {
...
const AsyncSomeComponent = Object(lib_async_component__WEBPACK_IMPORTED_MODULE_2__["asyncComponent"])({
  loader: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 48)).catch(err => {
...
class App extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("h1", null, "This Is Cool! ", this.state.count), react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("button", {
      onClick: () => this.setState({
        count: this.state.count + 1
      })
    }, "Increment"), react__WEBPACK_IMPORTED_MODULE_0__["createElement"](AsyncSomeComponent, null, react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, "Hello There")), react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("hr", null), react__WEBPACK_IMPORTED_MODULE_0__["createElement"](components_StaticComponent__WEBPACK_IMPORTED_MODULE_3__["default"], null));
  }
...
(function () {
  ...
  reactHotLoader.register(AsyncSomeComponent, "AsyncSomeComponent", "/Volumes/Dev/projects/hot-server-demo/src/pages/index.tsx");
  reactHotLoader.register(App, "App", "/Volumes/Dev/projects/hot-server-demo/src/pages/index.tsx");
  reactHotLoader.register(_default, "default", "/Volumes/Dev/projects/hot-server-demo/src/pages/index.tsx");
  leaveModule(module);
})();
...
var shallowEqual = _interopDefault(__webpack_require__(38));

var levenshtein = _interopDefault(__webpack_require__(39));

var PropTypes = _interopDefault(__webpack_require__(42));

var defaultPolyfill = __webpack_require__(44);

var defaultPolyfill__default = _interopDefault(defaultPolyfill);

var hoistNonReactStatic = _interopDefault(__webpack_require__(45));
...
function createClassProxy(InitialComponent, proxyKey, options) {
  ...
  if (!isFunctionalComponent) {
    ...
    _ProxyFacade = function ProxyFacade(props, context) {
      var result = CurrentComponent(props, context); // simple SFC
...
/* WEBPACK VAR INJECTION */(function(module) {var __WEBPACK_AMD_DEFINE_RESULT__;(function () {
  ...
  if ("function" !== "undefined" && __webpack_require__(40) !== null && __webpack_require__(41)) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractChunks", function() { return extractChunks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "preloadAll", function() { return preloadAll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "preloadReady", function() { return preloadReady; });
...
function addChunk(chunkFilename) {
...
const DefaultLoadingComponent = () => react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, "Loading...");

function queueLoader(loader) {
...
function asyncComponent({
  ...
  return class LoadableComponent extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    constructor(props) {
      super(props);
    ...
    render() {
      if (!LoadedComponent) {
        return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](LoadingComponent, null);
      }

      return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](LoadedComponent, this.props);
    }
...
(function () {
  ...
  reactHotLoader.register(chunks, "chunks", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  reactHotLoader.register(componentLoaders, "componentLoaders", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  reactHotLoader.register(addChunk, "addChunk", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  reactHotLoader.register(extractChunks, "extractChunks", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  reactHotLoader.register(DefaultLoadingComponent, "DefaultLoadingComponent", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  reactHotLoader.register(queueLoader, "queueLoader", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  reactHotLoader.register(preloadAll, "preloadAll", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  reactHotLoader.register(preloadReady, "preloadReady", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  reactHotLoader.register(asyncComponent, "asyncComponent", "/Volumes/Dev/projects/hot-server-demo/src/lib/async-component/index.tsx");
  leaveModule(module);
})();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StaticComponent; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lib_async_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46);
/* harmony import */ var _SomeComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(48);
(function () {
  var enterModule = __webpack_require__(36).enterModule;
...
const AsyncSomeComponent = Object(lib_async_component__WEBPACK_IMPORTED_MODULE_1__["asyncComponent"])({
  loader: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 48)).catch(err => {
    return console.log("why", err);
  }),
  chunkFilename: "SomeComponent"
});
class StaticComponent extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("h1", null, "StaticComponent"), react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_SomeComponent__WEBPACK_IMPORTED_MODULE_2__["default"], null));
  }
...
(function () {
  ...
  reactHotLoader.register(AsyncSomeComponent, "AsyncSomeComponent", "/Volumes/Dev/projects/hot-server-demo/src/components/StaticComponent.tsx");
  reactHotLoader.register(StaticComponent, "StaticComponent", "/Volumes/Dev/projects/hot-server-demo/src/components/StaticComponent.tsx");
  leaveModule(module);
})();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SomeComponent; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lib_async_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46);
(function () {
...
const SecondComponent = Object(lib_async_component__WEBPACK_IMPORTED_MODULE_1__["asyncComponent"])({
  loader: () => __webpack_require__.e(/* import() | SecondComponent */ 1).then(__webpack_require__.bind(null, 49)),
  chunkFilename: "SecondComponent"
});
class SomeComponent extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("h1", null, "SomeComponent"), react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, this.props.children), react__WEBPACK_IMPORTED_MODULE_0__["createElement"](SecondComponent, null));
  }
...
(function () {
  ...
  reactHotLoader.register(SecondComponent, "SecondComponent", "/Volumes/Dev/projects/hot-server-demo/src/components/SomeComponent.tsx");
  reactHotLoader.register(SomeComponent, "SomeComponent", "/Volumes/Dev/projects/hot-server-demo/src/components/SomeComponent.tsx");
  leaveModule(module);
})();
